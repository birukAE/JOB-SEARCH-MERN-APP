...
function JOURNALISEM() {
const[joblist,setJoblist]=useState([])
let history=useHistory();
useEffect(() => {


  Axios.get("http://localhost:3006/upload/journalisem").then((response)=>{
 setJoblist(response.data);
    ...
    return (
       ...
       <Catagory to ="/freelacing">fREELANCING</Catagory>
            ...
            {joblist.map((val,key)=> { 
              return( <GET>   <HH>JOURNALISEM AND MEDIA JOBS</HH> 
                       <Get><Ict>
